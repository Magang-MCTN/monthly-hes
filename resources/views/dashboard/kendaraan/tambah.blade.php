                ...
                <div class="container">
                    <div class="row px-5">
                        <div class="col d-flex justify-content-center">
                            ...
                            <h2 class="fw-bold d-flex" style="color: #097B96;">Tambah Kendaraan</h2>
                        </div>
                    </div>
                    <hr>
                    @if(session('success'))
                    ...
                    <form id="">
                        ...
                        <div class="row">
                            <div class="col form-group">
                                <label for="manPower">Plat Nomor</label>
                                <input type="text" name="manPower" id="manPower" class="form-control" required>
                            </div>
                            <div class="col form-group">
                                <label for="manHours">Masa Berlaku</label>
                                <input type="date" name="manHours" id="manHours" class="form-control" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col form-group">
                                <label for="manPower">Masa Berlaku KEUR/KIR</label>
                                <input type="date" name="manPower" id="manPower" class="form-control" required>
                            </div>
                            <div class="col form-group">
                                <label for="manHours">Kilometer</label>
