...
<div class="main-panel">
    <div class="container py-3 px-4">
        <div class="row">
            <h2 class="col fw-bold ms-4 mt-4">Daftar Report Bulanan</h2>
            <div class="col">
                <div class="row mb-4">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Oktober</td>
                                        <td>2023</td>
                                        <td><p class="badge badge-success">Disetujui</p></td>
                                        <td>
                                            <a href="/persetujuan/1" class="btn" style="background-color: #097b96; color: white" onmouseover="this.style.backgroundColor='#0B697F'" onmouseout="this.style.backgroundColor='#097B96'">Detail</a>
